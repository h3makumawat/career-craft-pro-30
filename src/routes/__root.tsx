  ...
  head: () => ({
    meta: [
      ...
      { title: "CareerCraft AI — Resume & LinkedIn Coach" },
      {
        name: "description",
        content:
          "Build a stronger career profile. Get interview-ready with AI-powered resume, LinkedIn and interview feedback.",
      },
      { property: "og:title", content: "CareerCraft AI — Resume & LinkedIn Coach" },
      {
        property: "og:description",
        content: "AI resume analysis, LinkedIn coaching and interview preparation.",
      },
